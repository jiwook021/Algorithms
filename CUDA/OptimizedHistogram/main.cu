/**
 * @file main.cu
 * @brief Driver for optimized histogram with GPU vs CPU comparison.
 *
 * Usage: ./main [data_size] [distribution]
 *   distribution: 0=uniform, 1=normal-like, 2=skewed
 */
...
int main(int argc, char** argv) {
    ...
    printf("Computing optimized histogram for %d data points with %d bins\n",
           dataSize, NUM_BINS);
    ...
    HistogramSharedKernel<<<gridSize, BLOCK_SIZE>>>(dData, dHistogram, dataSize, NUM_BINS);
