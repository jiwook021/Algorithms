/**
  ...
  */
  ...
  /** @defgroup FLASH_Timeout_definition FLASH Timeout definition
    ...
    * @{
    */
  #define HAL_FLASH_TIMEOUT_VALUE       50000U        /* 50 s */
  /**
    * @}
    */
  ...
  /** @defgroup FLASH_Voltage_Range FLASH Voltage Range
    * @{
    */
  ...
  /**
    * @brief  Flush the FLASH instruction Cache.
  ...
  /**
    * @brief  Flush the FLASH data Cache.
